...
export const FullScreenScrollFX = forwardRef<HTMLDivElement, FullScreenFXProps>(
  (
    ...
    const cssVars: CSSProperties = {
      ...
      ["--fx-page-bg" as string]: colors.pageBg ?? "#000",
    ...
    return (
      ...
      >
        ...
        <style>{`
          ...
          .fx-progress-numbers { position: absolute; inset: auto 0 100% 0; display: flex; justify-content: space-between; font-size: 0.8rem; color: var(--fx-text); padding-bottom: 4px; }
          .fx-progress-bar { width: 100%; height: 2px; background: rgba(245,245,245,0.28); position: relative; }
          .fx-end { height: 100vh; display: grid; place-items: center; background: #000; }
          .fx-fin { transform: rotate(90deg); color: rgba(255,255,255,0.2); letter-spacing: 0.3em; font-size: 0.8rem; }
